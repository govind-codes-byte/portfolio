...
const projects = [
  ...
  {
    id: 3,
    title: 'JobHub — Full-Stack Job Portal Platform',
    description: 'A full-stack job portal application built with React, Python, FastAPI and MongoDB. It allows users to browse job listings, apply for positions, and manage their profiles. The platform features a responsive design, secure authentication, and an intuitive user interface for both job seekers and employers.',
    image: '/project3.png',
    tags: ['Python', 'FastAPI', 'MongoDB'],
    liveUrl: 'https://job-hub-opal.vercel.app',
    githubUrl: 'https://github.com/govind-codes-byte/JobHub',
    featured: false,
    color: '#F59E0B',
  },
  // {
